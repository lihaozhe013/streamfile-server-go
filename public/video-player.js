...
(function(){
  function getQuery(k){
    const p=new URLSearchParams(location.search);return p.get(k)||'';
  }
  ...
  function flashSeek(text){
    ...
    if(!el){
      ...
      Object.assign(el.style, {
        ...
        background:'rgba(0,0,0,.6)', color:'#fff', padding:'6px 12px', borderRadius:'20px',
        fontSize:'14px', fontWeight:'500', zIndex:9999, opacity:'0', transition:'opacity .15s'
      });
    ...
    flashSeek._t = setTimeout(()=>{ el.style.opacity='0'; }, 350);
  }
